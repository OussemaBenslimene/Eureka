...
class AccessoiresInformatiqueApplicationTests {
	...
	public void testFindAccessoire() {
	    Optional<Accessoire> pOpt = accRepository.findById(10L);
	    if (pOpt.isPresent()) {
	        Accessoire p = pOpt.get();
	        System.out.println(p);
	    } else {
	        System.out.println("Accessoire non trouvé");
	    }
	}
	...
	public void testUpdateAccessoire() {
	    ...
	    if (pOpt.isPresent()) {
	        ...
	        System.out.println("Accessoire non trouvé pour la mise à jour");
	    }
	}
